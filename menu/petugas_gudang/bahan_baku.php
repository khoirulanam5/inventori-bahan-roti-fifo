            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input required type="text" class="form-control" id="max_keluar" name="max_keluar">
                    </div>
                    <div class="form-group">
...
<script>
    ...
    $(document).on('click', '#EditSupplier', function(e) {
        ...
        $('#modalku').modal('show');
        var fileedit = 'menu/petugas_gudang/bahan_baku_edit.php';
        $.ajax({
            type: 'POST',
            url: fileedit,
