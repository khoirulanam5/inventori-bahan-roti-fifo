                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            if ($data['status_pemilik'] == '0' && $data['status_admin'] == '1') {
                                            ?>
                                                <a onclick="return confirm('Anda Yakin ingin mengajukan pengajuan ini?')" href="proccess/pengajuan_pengadaan_bahan_baku_ajukan.php?k=dinas&id=<?= $data['id'] ?>"><span class="badge badge-success"> Setujui</span></a>
                                            <?php
                                            }
                                            ?>
                                        </td>
