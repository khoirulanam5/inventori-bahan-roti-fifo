    ...
    <div class="layout-px-spacing">
        <div class="layout-spacing mt-3">
            <div class="widget-content widget-content-area br-6">
                <form action="proccess/pengajuan_tambah.php" method="POST">
                    <h5 class="card-title">Transaksi Pengajuan</h5>
                    <hr>
                    <div class="col-lg-4">
...
<div class="modal fade" id="tambah_data" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <form action="proccess/pengajuan_tambah_data.php" method="POST">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input min="1" size="3" type="number" class="form-control" name="jumlah" id="jumlah" required>
                    </div>
                </div>
