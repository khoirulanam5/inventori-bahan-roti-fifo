...
$id = $_POST['ids'];
$query = $koneksi->query("SELECT * from tb_detail_pengajuan a JOIN tb_bahan_baku b ON a.id_bahan_baku=b.id_bahan_baku WHERE a.id_pengajuan='$id'");
?>
