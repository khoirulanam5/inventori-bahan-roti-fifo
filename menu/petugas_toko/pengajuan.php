        ...
        <div class="row" id="cancel-row">
            <div class="col-sm-12 layout-spacing">
                <div class="widget-content widget-content-area br-6">
                    <a href="?menu=pengajuan&p=tambah"><button type="button" class="btn btn-primary">Tambah</button></a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                ...
                                                <a href="#"><span onclick="hapus(this)" data-id="<?= $data['id_pengajuan'] ?>" class="badge badge-danger"><i class="far fa-trash-alt"></i></span></a>
                                            <?php
                                            }
                                            ?>
                                        </td>
...
if (isset($_GET['success'])) {
    alert_process($_GET['success'], true, "Produk", $_GET['menu']);
} else if (isset($_GET['fail'])) {
    alert_process($_GET['fail'], false, "Produk", $_GET['menu']);
}
?>
<!-- Modal -->
