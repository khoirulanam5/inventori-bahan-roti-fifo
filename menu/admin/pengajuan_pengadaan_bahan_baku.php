    ...
    <div class="layout-px-spacing">
        ...
        <div class="page-header">
            <div class="page-title">
                <h3>Data Pengadaan Bahan Baku</h3>
            </div>
        </div>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($data['status_admin'] == '0') {
                                            ?>
                                                <a onclick="return confirm('Anda Yakin ingin mengajukan pengajuan ini?')" href="proccess/pengajuan_pengadaan_bahan_baku_ajukan.php?k=sesi&id=<?= $data['id'] ?>"><span class="badge badge-success"> Setujui</span></a>
                                            <?php
                                            }
                                            ?>
                                        </td>
...
<script>
    $(document).on('click', '#LihatSupplier', function(e) {
        ...
        $('#modalku2').modal('show');
        var fileedit = 'menu/admin/pengajuan_pengadaan_bahan_baku_detail.php';
        $.ajax({
            type: 'POST',
            url: fileedit,
