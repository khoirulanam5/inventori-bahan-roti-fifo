                    ...
                    <div class="table-responsive mb-4 mt-4">
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            <tbody>
                                <?php
                                $i = 1;
                                $view = list_pengajuan_petugas_produksi();
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if ($data['status'] == '0') {
                                            ?>
                                                <a onclick="return confirm('Anda Yakin ingin validasi pengajuan ini?')" href="proccess/pengajuan_validasi.php?id=<?= $data['id_pengajuan'] ?>"><span class="badge badge-success"> ACC</span></a>
                                            <?php
                                            }
                                            ?>
                                        </td>
