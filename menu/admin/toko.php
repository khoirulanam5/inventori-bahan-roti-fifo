                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= $data['no_hp'] ?></td>
                                        <td>
                                            <a href="#" id="EditSupplier" data-id="<?= $data['id_toko']; ?>"><span class="badge badge-success"><i class="far fa-edit"></i></span></a>
                                            <a href="#"><span onclick="hapus(this)" data-id="<?= $data['id_toko'] ?>" class="badge badge-danger"><i class="far fa-trash-alt"></i></span></a>
                                        </td>
                                    </tr>
                                <?php
                                endforeach;
...
if (isset($_GET['success'])) {
    alert_process($_GET['success'], true, "Toko", $_GET['menu']);
} else if (isset($_GET['fail'])) {
    alert_process($_GET['fail'], false, "Toko", $_GET['menu']);
}
?>
<!-- Modal -->
            ...
            .then((result) => {
                if (result.value) {
                    $.ajax({
                        ...
                        url: 'proccess/toko_hapus.php', // File yang akan memproses data
                        data: 'id=' + id,
                        dataType: "html",
                        success: function(response) {
                            ...
                            window.setTimeout(function() {
                                window.location.replace('?menu=toko');
                            }, 1000);
                        }
                    });
                }
